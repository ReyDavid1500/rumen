  ...
  return (
    <ShopLayout>
      <div className="bg-white w-[80%] md:w-[30%] md:mt-20 h-[60%] m-auto rounded-lg overflow-hidden mt-10">
        <header className="bg-green-600 align-middle h-[30%] p-6">
        ...
        <main className="p-6">
          <form className="flex flex-col gap-4">
            ...
            <Link
              to="/order"
              className="bg-green-600 text-white p-2 font-bold rounded-lg hover:bg-green-600/50 w-[80%] m-auto text-center"
            >
              Ingresa a tu cuenta
            </Link>
            <div className="flex flex-row gap-1 items-center">
              <p className="text-xs">No estas registrado?</p>
              <Link className="text-xs font-bold text-green-600" to="/signup">
                Registrate!!
              </Link>
            </div>
          </form>
